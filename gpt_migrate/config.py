...
EXTENSION_TO_TREE_SITTER_GRAMMAR_REPO = {
    'py': f"{TREE_SITTER_REPO_STUB}python",
    'js': f"{TREE_SITTER_REPO_STUB}javascript",
    'java': f"{TREE_SITTER_REPO_STUB}java",
    'rb': f"{TREE_SITTER_REPO_STUB}ruby",
    'php': f"{TREE_SITTER_REPO_STUB}php",
    'cs': f"{TREE_SITTER_REPO_STUB}c-sharp",
    'go': f"{TREE_SITTER_REPO_STUB}go",
    'rs': f"{TREE_SITTER_REPO_STUB}rust",
    'cpp': f"{TREE_SITTER_REPO_STUB}cpp",
    'cc': f"{TREE_SITTER_REPO_STUB}cpp",
    'cxx': f"{TREE_SITTER_REPO_STUB}cpp",
    'c': f"{TREE_SITTER_REPO_STUB}c",
    'swift': f"{TREE_SITTER_REPO_STUB}swift",
    'scala': f"{TREE_SITTER_REPO_STUB}scala",
    'ts': f"{TREE_SITTER_REPO_STUB}typescript",
    'tsx': f"{TREE_SITTER_REPO_STUB}typescript",
    'jsx': f"{TREE_SITTER_REPO_STUB}javascript",
    'hs': f"{TREE_SITTER_REPO_STUB}haskell",
    'jl': f"{TREE_SITTER_REPO_STUB}julia",
}
